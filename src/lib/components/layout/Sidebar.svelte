			...
			<div class="px-2.5 flex justify-center text-gray-800 dark:text-gray-200">
				...
				>
					<div class="self-center">
						...
						<img src="	https://img.icons8.com/?size=512&id=xMSjkjVtWxSi&format=png" alt="icon" class="size-[1.1rem]" style="filter: invert(100%)">
					</div>

					<div class="flex self-center">
						<div class=" self-center font-medium text-sm">{$i18n.t('Video')}</div>
					</div>
				</a>
			</div>
		{/if}
